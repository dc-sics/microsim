...
public class PersonExample {
    ...
    **/
     ...
     **/
    class EventReport {
		HashMap<Double,Double> pt = new HashMap<>();
		HashMap<Double,Integer> events = new HashMap<>();
    ...
    public void init () {
		...
		double t_onset = ageCancerOnset - 35.0;
		// Gleason score
    ...
    class Localised extends cMessage {
		public void execute() {
			...
			double t_onset = ageCancerOnset - 35.0;
			double psa_onset = psaMean(sim.time());
    ...
    private double psaMean(double age) {
		...
		double t_onset = ageCancerOnset - 35.0;
		double yt = age<ageCancerOnset ? Math.exp(beta0+beta1*t) : Math.exp(beta0+beta1*t+beta2*(t-t_onset));
		return yt;
    }
    ...
    public void simulateOneRun () {
		...
		csim.start();
		System.out.println(psaMean(35));
		System.out.println(psaMeasured(35));
		System.out.println(psaMean(105));
		System.out.println(psaMeasured(105));
		noisy = false;
    }
